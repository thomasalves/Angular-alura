                ...
                importaDados() {
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            const negociocoesJaImportadas = this._negociacoes.paraArray();
                            negociacoesParaImportar.filter(negociacao => !negociocoesJaImportadas.some(jaImportada => negociacao.ehIgual(jaImportada)))
